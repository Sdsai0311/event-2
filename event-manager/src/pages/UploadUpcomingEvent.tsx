...
import { simulateEmailNotification } from '../utils/eventUtils';
...
export const UploadUpcomingEvent: React.FC = () => {
    ...
    const onSubmit = async (data: UpcomingEventFormData) => {
        // Normally you'd upload the image to Firebase/Supabase storage here
        // For this implementation, we use the base64 preview or a placeholder
        ...
        await addEvent({
            ...
            facultyCoordinator: data.organizerName, // Mapping for backward compatibility
            objectives: '', // Default empty for this form
            outcomes: '',
            ...
            dayOfChecklist: [],
            guestCount: {
                estimated: data.maxParticipants,
                confirmed: 0,
            },
        ...
        simulateEmailNotification(data.title);
        ...
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-6 animate-in zoom-in-95 duration-500">
                ...
                <div className="text-center">
                    <h2 className="text-3xl font-black text-slate-900">Event Uploaded!</h2>
                    <p className="text-slate-500 font-medium">Your event has been submitted for admin approval.</p>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="max-w-5xl mx-auto pb-20">
            <div className="flex items-center space-x-4 mb-8">
                ...
                <div>
                    <h1 className="text-3xl font-black text-slate-900 tracking-tight">Upload Upcoming Event</h1>
                    <p className="text-sm font-bold text-slate-400 uppercase tracking-widest mt-1">Organize and Manage New Events</p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="space-y-6">
                        ...
                        <div className="mt-6 p-4 bg-slate-50 rounded-2xl border border-slate-100">
                            <div className="flex items-start space-x-3">
                                ...
                                <p className="text-xs text-slate-500 font-medium leading-relaxed">
                                    Posters with clear dates and eye-catching designs get 40% more registrations.
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="p-4 flex items-center justify-center space-x-2">
                        <Badge variant="warning" className="animate-pulse">Next Step</Badge>
                        <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Admin Review</span>
                    </div>
                </div>
            </form>
        </div>
